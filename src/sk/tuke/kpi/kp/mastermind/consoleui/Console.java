...
public class Console {
    ...
    private static RatingService rattingService = null;
        ...
        do {
            ...
            if (Pattern.matches("A[RBGYPC][1-4]", input)) {
                ...
                switch (input.charAt(1)) {
                    case 'R':
                        Game.getGame().putPin(Pin.RED, index);
                        break;
                    case 'B':
                        Game.getGame().putPin(Pin.BLUE, index);
                        break;
                    case 'G':
                        Game.getGame().putPin(Pin.GREEN, index);
                        break;
                    case 'Y':
                        Game.getGame().putPin(Pin.YELLOW, index);
                        break;
                    case 'P':
                        Game.getGame().putPin(Pin.PURPLE, index);
                        break;
                    case 'C':
                        Game.getGame().putPin(Pin.CYAN, index);
                        break;
                    default:
                        break;
                }
            ...
            //Evaluate guess
                ...
                if (emptyHoles > 0) {
                    ...
                    System.out.print("Evaluation - Round " + (Game.getGame().getRound() + 1) + ": ");
                    show(Game.getGame().getPlayerHoles(), 4);
